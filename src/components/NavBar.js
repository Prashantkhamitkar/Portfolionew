  ...
  return (
    <header className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8' >
        ...
        <nav className='flex items-center justify-center flex-wrap'>
            <motion.a href="https://github.com/Prashantkhamitkar" target={'_blank'}
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className='w-6 mx-3'
            >
            ...
            <motion.a href="https://www.linkedin.com/in/prashant-khamitkar-8775b9149/"
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className='w-6 mx-3'
            target={'_blank'}>
            ...
            <motion.a href="https://twitter.com/PrashantKh29761" 
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className='w-6 mx-3'
            target={'_blank'}>
            ...
            <motion.a href="https://in.pinterest.com/prashantkhamitkar74/" 
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            ...
            <motion.a href="https://dribbble.com/prashantkhamitkar/"
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className='w-6 ml-3'
            target={'_blank'}>
        ...
        </div>
        {
          ...
          <nav className='flex items-center justify-center flex-wrap mt-2'>
              <motion.a href="https://github.com/Prashantkhamitkar?tab=repositories" target={'_blank'}
              whileHover={{y:-2}}
              whileTap={{scale:0.9}}
